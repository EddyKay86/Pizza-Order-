...
while True:
    ...
    if user_choice == 1:
        ...
        if not To_Do:
            ...
            index = int(input("Enter the index of the activity you want to update: "))
            if 0<=index<len(To_Do):
                new_update = input("Enter update: \n")
                To_Do[index]= new_update
                print(f"{new_update} updated sucessfully")
            else:
                print("Invalid index")
    elif user_choice == 3:
        if not To_Do:
            ...
            index=int(input("Enter the index of the activity you to delete: "))
            if 0<=index<len(To_Do):
